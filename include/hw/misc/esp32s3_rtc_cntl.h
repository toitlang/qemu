...
#define ESP32S3_ULP_TIMER_GPIO        "enable-gpio-timer"
#define ESP32S3_SET_ULP_PC_GPIO       "set_ulp_pc"
#define ESP32S3_RTC_WAKEUP_GPIO       "rtc-wakeup"
...
typedef struct Esp32s3RtcCntlState {
    ...
    uint32_t sdio_conf;
    uint32_t dig_pwc;
    uint32_t ulp_cp_timer;
    uint32_t ulp_cp_timer1;
...
REG32(RTC_CNTL_WAKEUP_STATE, 0x3c)
    FIELD(RTC_CNTL_WAKEUP_STATE, WAKEUP_ENA, 15,11)
    FIELD(RTC_CNTL_WAKEUP_STATE, WAKEUP_ENA_EXT0, 15,1)
    FIELD(RTC_CNTL_WAKEUP_STATE, WAKEUP_ENA_EXT1, 16,1)
    FIELD(RTC_CNTL_WAKEUP_STATE, WAKEUP_ENA_GPIO, 17,1)
    FIELD(RTC_CNTL_WAKEUP_STATE, WAKEUP_ENA_RTC_TIMER, 18,1)
...
REG32(RTC_CNTL_RTC_LOW_POWER_ST ,0xD0)
    FIELD(RTC_CNTL_LOW_POWER_ST, RTC_RDY_FOR_WAKEUP, 19,1)

REG32(RTC_CNTL_EXT_WAKEUP1 ,0xe0)
    FIELD(RTC_CNTL_EXT_WAKEUP1, SEL, 0,22)
...
REG32(RTC_CNTL_ULP_CP_CRTL, 0x100)
    FIELD(RTC_CNTL_ULP_CP_CRTL,START_TOP,31,1)

REG32(RTC_CNTL_ULP_CP_TIMER1, 0x134)
    FIELD(RTC_CNTL_ULP_CP_TIMER1,SLP_CYCLE,0,11)

REG32(RTC_CNTL_RTC_SLP_WAKEUP_CAUSE, 0x130)
